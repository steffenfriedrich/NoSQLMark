...
public class SickStoreClient extends DB {
    ...
    private static final Logger logger = LoggerFactory.getLogger("sickstore");
    ...
    public void cleanup() throws DBException {
        try {
            ...
            //logger.error("An Exception was thrown during cleanup at", e);
        }
    }
    ...
    public Status delete(String table, String key) {
        try {
            ...
            //logger.error("An Exception was thrown during delete at", e);
            return Status.ERROR;
        }
    }
    ...
    public void init() throws DBException {
        ...
        int maxconnections = Integer.parseInt(props.getProperty("sickstore.maxconnections", "16"));
